...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-50">
      <div className="flex items-center justify-center gap-2 bg-ink px-4 py-2.5 text-center text-xs text-ink-foreground">
        <Sparkles className="h-3.5 w-3.5 text-primary" />
        <span>Made for how you feel, not just what you crave.</span>
      </div>
